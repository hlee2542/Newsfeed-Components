...
const data = [
  ...
  {
    title: 'Best Places to Work in 2020',
    date: 'Jan 1st, 2020',
    firstParagraph: `Lucas ipsum dolor sit amet ben twi'lek padmé darth darth darth moff hutt organa twi'lek. Ben amidala secura skywalker lando
    moff wicket tatooine luke.Solo wampa wampa calrissian yoda moff.Darth grievous darth gonk darth hutt.Darth baba skywalker
    watto fett jango maul han.Mon ewok sidious sidious lando kenobi grievous gamorrean solo.Yoda wedge utapau darth calamari.
...
function createArticle(data) {
  ...
  container.classList.toggle('article');
  ...
  container.append(firstP);
  container.append(secondP);
  container.append(thirdP);
...
let allArticles = data.map(article => createArticle(article));
allArticles.forEach(article => articles.append(article));